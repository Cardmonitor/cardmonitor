            ...
            <table class="table table-sm table-hover table-striped bg-white">
                ...
                <tbody>
                    <template v-for="(item, index) in items">
                        <row :card="cards[item.sku]" :conditions="conditions" :item="item" :index="index" :key="item.id" @deleted="remove(index)" @updated="updated(index, $event)" @show="showImgbox($event)" @hide="hideImgbox()" @toshow="toshow(index, item)"></row>
                    </template>
                </tbody>
                <tfoot>

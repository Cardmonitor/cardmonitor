    ...
    <tr v-if="isEditing">
        ...
        <td class="align-middle d-none d-sm-table-cell text-right">
            <div class="btn-group btn-group-sm" role="group">
                ...
                <button type="button" class="btn btn-secondary" :title="$t('app.actions.save_upload')" @click="update(true)" v-show="item.number"><i class="fas fa-fw fa-cloud-upload-alt"></i></button>
